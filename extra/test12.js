...
// Example private keys and public key recipient (same as in your original code)
let privateKey0 = "d653763be1854048e1a70dd9fc94d47c09c790fb1530a01ee65257b0b698c352";
let privateKey1 = "e36a688fe085087299ea6225c6be269f05d1f2e63bfe00d41c1627a826c69789";
let privateKey3 = "a169b38267e4134dc2413ca0eb29cc27a6e80e6a412855a839cfb81e342da950";
let publicKeyRecipient = "0x040b670b840bdce35bd1d14e43757d443fefea38560a48f7bf768b94f1626cb9c3d211429983c6eeee626ea90db846bb76dbf378ccd3f7d0a6826ee25292aab40d";
...
export async function sendTxSelectedUTXO() {
    ...
    // Constructing a P2PKH payment for testnet
    const p2pkh = bitcoin.payments.p2pkh({
        pubkey: Buffer.from(publicKeySender.slice(2), "hex"),
        network: network,
    });
    ...
    psbt.addInput({
        ...
        nonWitnessUtxo: Buffer.from(selectedUtxo.rawTxHex, 'hex'), // Raw transaction is needed for nonWitnessUtxo
    });
